...
Central documentation hub for the Kickback KKB-F1 Contract Register automation.  
Use the left navigation or the index below to open each document.
...
UI screenshots referenced by the runbook and test cases.
...
You can link these files directly from each markdown document as needed.

---

## 6. Slack

Slack notification screenshots used in test scenarios.
